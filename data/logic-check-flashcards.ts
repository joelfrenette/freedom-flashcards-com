export const allLogicCheckFlashcards = [
  {
    id: 1,
  ...
  },
  {
    ...
    truth:
      "Then why did 600,000 Americans die in a war to end it? Why did we fight the bloodiest war in our history to abolish something we were 'built on'?",
    sources: [
      {
    ...
    sources: [
      {
        ...
        url: "https://www.merriam-webster.com/dictionary/violence",
      },
      {
