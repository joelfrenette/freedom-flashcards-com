...
export default function AntiAmericanPage() {
  const [flashcards, setFlashcards] = useState(allAntiAmericanFlashcards)
  ...
  useEffect(() => {
    const savedData = localStorage.getItem("flashcards-anti-american")
    if (savedData) {
      try {
        ...
        setFlashcards(allAntiAmericanFlashcards)
      }
    }
  }, [])
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">These Views Are Anti-American</h1>
          <p className="text-xl text-gray-600 mb-4">Challenging false claims about America</p>
          <p className="text-gray-600">
            Identify and counter narratives that undermine American values, history, and founding principles.
          </p>
        </div>
